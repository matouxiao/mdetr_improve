...
class Transformer(nn.Module):
    def __init__(
        ...
        # 使用本地路径加载roberta-base
        local_roberta = "/workapp1219/detr/mdetr/roberta-base"
        self.tokenizer = RobertaTokenizerFast.from_pretrained(local_roberta, local_files_only=True)
        self.text_encoder = RobertaModel.from_pretrained(local_roberta, local_files_only=True)
